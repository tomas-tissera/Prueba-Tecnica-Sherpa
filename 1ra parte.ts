  ...
  for (let retry1 = 0; retry1 < MAX_ACTION_RETRIES; retry1++) {
    try {
      ...
      await delay(500); // Pausa después de hacer scroll
      ...
      await delay(500); // Pausa después de esperar el botón de descarga
      ...
      await delay(500); // Pausa después de hacer clic en Descargar PDF
  ...
  await delay(500); // Pausa después de analizar el primer PDF
  ...
  await delay(500); // Pausa después de hacer clic en la página 2
  await page.waitForLoadState('networkidle');
