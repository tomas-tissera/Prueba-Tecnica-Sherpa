import { findFinalPassword } from './PASO 4/desafioFinal';
const { firefox, Page, Download } = require('playwright'); // Cambiado a 'firefox'
const fs = require('fs');
const pdf = require('pdf-parse');

const claves = []; // Array para almacenar las claves
